...
implements Util {
    ...
    public static Vec3d getInterpolatedPos(Entity entity, float partialTicks) {
        return new Vec3d(entity.lastTickPosX, entity.lastTickPosY, entity.lastTickPosZ).add(EntityUtilPhob.getInterpolatedAmount(entity, partialTicks));
    }

    public static Vec3d getInterpolatedRenderPos(Entity entity, float partialTicks) {
        return EntityUtilPhob.getInterpolatedPos(entity, partialTicks).subtract(EntityUtil.mc.getRenderManager().renderPosX, EntityUtil.mc.getRenderManager().renderPosY, EntityUtil.mc.getRenderManager().renderPosZ);
    }
    ...
    public static Vec3d getInterpolatedAmount(Entity entity, Vec3d vec) {
        return EntityUtilPhob.getInterpolatedAmount(entity, vec.x, vec.y, vec.z);
    }
    ...
    public static List<Vec3d> getUnsafeBlocks(Entity entity, int height, boolean floor, boolean face) {
        return EntityUtilPhob.getUnsafeBlocksFromVec3d(entity.getPositionVector().add(0.0, 0.125, 0.0), height, floor, face);
    }
    ...
    public static boolean isInHole(Entity entity) {
        return EntityUtilPhob.isBlockValid(new BlockPos(entity.posX, entity.posY, entity.posZ));
    }
    ...
    public static boolean isAboveWater(Entity entity, boolean packet) {
        ...
        double y = entity.posY - (packet ? 0.03 : (EntityUtilPhob.isPlayer(entity) ? 0.2 : 0.5));
        for (int x = MathHelper.floor((double)entity.posX); x < MathHelper.ceil((double)entity.posX); ++x) {
            for (int z = MathHelper.floor((double)entity.posZ); z < MathHelper.ceil((double)entity.posZ); ++z) {
    ...
    public static List<Vec3d> getUntrappedBlocksExtended(int extension, EntityPlayer player, boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop, boolean raytrace, boolean noScaffoldExtend, boolean face) {
        ...
        if (extension == 1) {
            placeTargets.addAll(EntityUtilPhob.targets(player.getPositionVector(), antiScaffold, antiStep, legs, platform, antiDrop, raytrace, face));
        } else {
            int extend = 1;
    ...
    public static boolean isAlive(Entity entity) {
        return EntityUtilPhob.isLiving(entity) && !entity.isDead && ((EntityLivingBase)entity).getHealth() > 0.0f;
    }
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || EntityUtilPhob.isDead(entity) || entity.equals((Object)EntityUtil.mc.player) || entity instanceof EntityPlayer && OyVey.friendManager.isFriend(entity.getName()) || EntityUtil.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static boolean holding32k(EntityPlayer player) {
        return EntityUtilPhob.is32k(player.getHeldItemMainhand());
    }
