...
implements Util {
    ...
    public static void placeBlockRealth(BlockPos pos) {
        for (EnumFacing side : EnumFacing.VALUES) {
            ...
            boolean sneak = !BlockUtil.mc.player.isSneaking() && neighborState.getBlock().onBlockActivated((World)BlockUtil.mc.world, pos, BlockUtil.mc.world.getBlockState(pos), (EntityPlayer)BlockUtil.mc.player, EnumHand.MAIN_HAND, side, 0.5f, 0.5f, 0.5f);
            boolean bl = sneak;
            if (sneak) {
