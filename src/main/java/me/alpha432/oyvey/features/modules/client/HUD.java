...
extends Module {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        if (this.waterMark.getValue().booleanValue()) {
            string = "Xulu+" + (Object)ChatFormatting.LIGHT_PURPLE + "v" + "1.0.5" + (Object)ChatFormatting.WHITE + " | " + (Object)ChatFormatting.RESET + (Object)ChatFormatting.BOLD + Minecraft.debugFPS + (Object)ChatFormatting.WHITE + " Frames | " + (Object)ChatFormatting.RESET + (Object)ChatFormatting.BOLD + OyVey.serverManager.getPing() + (Object)ChatFormatting.WHITE + " Ms";
        ...
        if (this.waterMark2.getValue().booleanValue()) {
            string = "welcome Fucker " + HUD.mc.player.getDisplayNameString();
            if (ClickGui.getInstance().rainbow.getValue().booleanValue()) {
                if (ClickGui.getInstance().rainbowModeHud.getValue() == ClickGui.rainbowMode.Static) {
        ...
        if (this.waterMark3.getValue().booleanValue()) {
            string = "" + (Object)ChatFormatting.BOLD + (Object)ChatFormatting.WHITE + HUD.mc.player.inventory.mainInventory.stream().filter(itemStack -> itemStack.getItem() == Items.TOTEM_OF_UNDYING).mapToInt(ItemStack::getCount).sum() + (Object)ChatFormatting.RESET + " totems left";
            if (ClickGui.getInstance().rainbow.getValue().booleanValue()) {
                if (ClickGui.getInstance().rainbowModeHud.getValue() == ClickGui.rainbowMode.Static) {
    ...
    public void renderGreeter() {
        int width = this.renderer.scaledWidth;
        String text = " Client: Xulu+ Build: v1.0.5Player: ";
        if (this.greeter.getValue().booleanValue()) {
    ...
    public void renderLag() {
        ...
        if (OyVey.serverManager.isServerNotResponding()) {
            String text = (Object)ChatFormatting.RED + "server lagging for " + MathUtil.round((float)OyVey.serverManager.serverRespondingTime() / 1000.0f, 1) + "s.";
    ...
    public void renderPerformanceInfo() {
        ...
        char[] stringToCharArray;
        int[] arrayOfInt;
        String fps = (Object)ChatFormatting.WHITE + "FPS: " + (Object)ChatFormatting.RESET + Minecraft.debugFPS;
