...
implements Util {
    ...
    public static void drawGradientPlane(BlockPos pos, EnumFacing face, Color startColor, Color endColor, boolean half, boolean top) {
        ...
        IBlockState iblockstate = RenderUtill.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtill.mc.player, mc.getRenderPartialTicks());
        AxisAlignedBB bb = iblockstate.getSelectedBoundingBox((World)RenderUtill.mc.world, pos).grow((double)0.002f).offset(-interp.x, -interp.y, -interp.z);
    ...
    public static void drawGradientPlane(BlockPos pos, EnumFacing face, Color startColor, Color endColor, double height) {
        ...
        IBlockState iblockstate = RenderUtill.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtill.mc.player, mc.getRenderPartialTicks());
        AxisAlignedBB bb = iblockstate.getSelectedBoundingBox((World)RenderUtill.mc.world, pos).grow((double)0.002f).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0);
        float red = (float)startColor.getRed() / 255.0f;
        float green = (float)startColor.getGreen() / 255.0f;
        float blue = (float)startColor.getBlue() / 255.0f;
        float alpha = (float)startColor.getAlpha() / 255.0f;
    ...
    public static void drawGradientBlockOutline(BlockPos pos, Color startColor, Color endColor, float linewidth, double height) {
        IBlockState iblockstate = RenderUtill.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtill.mc.player, mc.getRenderPartialTicks());
        RenderUtill.drawGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtill.mc.world, pos).grow((double)0.002f).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0), startColor, endColor, linewidth);
    }
    ...
    public static void drawProperGradientBlockOutline(BlockPos pos, Color startColor, Color midColor, Color endColor, float linewidth) {
        IBlockState iblockstate = RenderUtill.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtill.mc.player, mc.getRenderPartialTicks());
        RenderUtill.drawProperGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtill.mc.world, pos).grow((double)0.002f).offset(-interp.x, -interp.y, -interp.z), startColor, midColor, endColor, linewidth);
    }
    ...
    public static void drawGradientFilledBox(BlockPos pos, Color startColor, Color endColor) {
        IBlockState iblockstate = RenderUtill.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtill.mc.player, mc.getRenderPartialTicks());
        RenderUtill.drawGradientFilledBox(iblockstate.getSelectedBoundingBox((World)RenderUtill.mc.world, pos).grow((double)0.002f).offset(-interp.x, -interp.y, -interp.z), startColor, endColor);
    }
    ...
    public static void glScissor(float x, float y, float x1, float y1, ScaledResolution sr) {
        GL11.glScissor((int)((int)(x * (float)sr.getScaleFactor())), (int)((int)((float)RenderUtill.mc.displayHeight - y1 * (float)sr.getScaleFactor())), (int)((int)((x1 - x) * (float)sr.getScaleFactor())), (int)((int)((y1 - y) * (float)sr.getScaleFactor())));
    }
    ...
    public static void drawBox(BlockPos pos, Color color) {
        AxisAlignedBB bb = new AxisAlignedBB((double)pos.getX() - RenderUtill.mc.getRenderManager().viewerPosX, (double)pos.getY() - RenderUtill.mc.getRenderManager().viewerPosY, (double)pos.getZ() - RenderUtill.mc.getRenderManager().viewerPosZ, (double)(pos.getX() + 1) - RenderUtill.mc.getRenderManager().viewerPosX, (double)(pos.getY() + 1) - RenderUtill.mc.getRenderManager().viewerPosY, (double)(pos.getZ() + 1) - RenderUtill.mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(RenderUtill.mc.getRenderViewEntity()).posX, RenderUtill.mc.getRenderViewEntity().posY, RenderUtill.mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtill.mc.getRenderManager().viewerPosX, bb.minY + RenderUtill.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtill.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtill.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtill.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtill.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
            GlStateManager.disableDepth();
            GlStateManager.tryBlendFuncSeparate((int)770, (int)771, (int)0, (int)1);
    ...
    public static void drawBox(BlockPos pos, Color color, double height, boolean gradient, boolean invert, int alpha) {
        ...
        AxisAlignedBB bb = new AxisAlignedBB((double)pos.getX() - RenderUtill.mc.getRenderManager().viewerPosX, (double)pos.getY() - RenderUtill.mc.getRenderManager().viewerPosY, (double)pos.getZ() - RenderUtill.mc.getRenderManager().viewerPosZ, (double)(pos.getX() + 1) - RenderUtill.mc.getRenderManager().viewerPosX, (double)(pos.getY() + 1) - RenderUtill.mc.getRenderManager().viewerPosY + height, (double)(pos.getZ() + 1) - RenderUtill.mc.getRenderManager().viewerPosZ);
        camera.setPosition(Objects.requireNonNull(RenderUtill.mc.getRenderViewEntity()).posX, RenderUtill.mc.getRenderViewEntity().posY, RenderUtill.mc.getRenderViewEntity().posZ);
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtill.mc.getRenderManager().viewerPosX, bb.minY + RenderUtill.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtill.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtill.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtill.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtill.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
    ...
    public static void drawBlockOutline(BlockPos pos, Color color, float linewidth, boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtill.mc.world.getWorldBorder().contains(pos)) {
            Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtill.mc.player, mc.getRenderPartialTicks());
            RenderUtill.drawBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtill.mc.world, pos).grow((double)0.002f).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
        }
    }
    ...
    public static void drawBlockOutline(BlockPos pos, Color color, float linewidth, boolean air, double height, boolean gradient, boolean invert, int alpha) {
        ...
        IBlockState iblockstate = RenderUtill.mc.world.getBlockState(pos);
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtill.mc.world.getWorldBorder().contains(pos)) {
            AxisAlignedBB blockAxis = new AxisAlignedBB((double)pos.getX() - RenderUtill.mc.getRenderManager().viewerPosX, (double)pos.getY() - RenderUtill.mc.getRenderManager().viewerPosY, (double)pos.getZ() - RenderUtill.mc.getRenderManager().viewerPosZ, (double)(pos.getX() + 1) - RenderUtill.mc.getRenderManager().viewerPosX, (double)(pos.getY() + 1) - RenderUtill.mc.getRenderManager().viewerPosY + height, (double)(pos.getZ() + 1) - RenderUtill.mc.getRenderManager().viewerPosZ);
            RenderUtill.drawBlockOutline(blockAxis.grow((double)0.002f), color, linewidth);
        }
    }
    ...
    public static void drawBoxESP(BlockPos pos, Color color, float lineWidth, boolean outline, boolean box, int boxAlpha) {
        ...
        if (camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtill.mc.getRenderManager().viewerPosX, bb.minY + RenderUtill.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtill.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtill.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtill.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtill.mc.getRenderManager().viewerPosZ))) {
            ...
            GL11.glHint((int)3154, (int)4354);
            GL11.glLineWidth((float)lineWidth);
            double dist = RenderUtill.mc.player.getDistance((double)((float)pos.getX() + 0.5f), (double)((float)pos.getY() + 0.5f), (double)((float)pos.getZ() + 0.5f)) * 0.75;
            if (box) {
    ...
    public void drawText(BlockPos pos, String text, Color color) {
        ...
        GlStateManager.pushMatrix();
        RenderUtill.glBillboardDistanceScaled((float)pos.getX() + 0.5f, (float)pos.getY() + 0.5f, (float)pos.getZ() + 0.5f, (EntityPlayer)RenderUtill.mc.player, 1.0f);
        GlStateManager.disableDepth();
    ...
    public static void drawOutlinedBlockESP(BlockPos pos, Color color, float linewidth) {
        IBlockState iblockstate = RenderUtill.mc.world.getBlockState(pos);
        Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtill.mc.player, mc.getRenderPartialTicks());
        RenderUtill.drawBoundingBox(iblockstate.getSelectedBoundingBox((World)RenderUtill.mc.world, pos).grow((double)0.002f).offset(-interp.x, -interp.y, -interp.z), linewidth, ColorUtil.toRGBA(color));
    }

    public static void blockEsp(BlockPos blockPos, Color c, double length, double length2) {
        double x = (double)blockPos.getX() - RenderUtill.mc.renderManager.renderPosX;
        double y = (double)blockPos.getY() - RenderUtill.mc.renderManager.renderPosY;
        double z = (double)blockPos.getZ() - RenderUtill.mc.renderManager.renderPosZ;
        GL11.glPushMatrix();
    ...
    public static void glrendermethod() {
        ...
        GL11.glDisable((int)2929);
        double viewerPosX = RenderUtill.mc.getRenderManager().viewerPosX;
        double viewerPosY = RenderUtill.mc.getRenderManager().viewerPosY;
        double viewerPosZ = RenderUtill.mc.getRenderManager().viewerPosZ;
        GL11.glPushMatrix();
    ...
    public static void glBillboard(float x, float y, float z) {
        ...
        GlStateManager.translate((double)((double)x - RenderUtill.mc.getRenderManager().renderPosX), (double)((double)y - RenderUtill.mc.getRenderManager().renderPosY), (double)((double)z - RenderUtill.mc.getRenderManager().renderPosZ));
        GlStateManager.glNormal3f((float)0.0f, (float)1.0f, (float)0.0f);
        GlStateManager.rotate((float)(-RenderUtill.mc.player.rotationYaw), (float)0.0f, (float)1.0f, (float)0.0f);
        GlStateManager.rotate((float)RenderUtill.mc.player.rotationPitch, (float)(RenderUtill.mc.gameSettings.thirdPersonView == 2 ? -1.0f : 1.0f), (float)0.0f, (float)0.0f);
    ...
    public static void drawSphere(double x, double y, double z, float size, int slices, int stacks) {
        ...
        GL11.glTranslated((double)(x - RenderUtill.mc.renderManager.renderPosX), (double)(y - RenderUtill.mc.renderManager.renderPosY), (double)(z - RenderUtill.mc.renderManager.renderPosZ));
    ...
    public static boolean isInViewFrustrum(Entity entity) {
        return RenderUtill.isInViewFrustrum(entity.getEntityBoundingBox()) || entity.ignoreFrustumCheck;
    }
    ...
    public static void checkSetupFBO() {
        Framebuffer fbo = RenderUtill.mc.framebuffer;
    ...
    private static void setupFBO(Framebuffer fbo) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT((int)36161, (int)34041, (int)RenderUtill.mc.displayWidth, (int)RenderUtill.mc.displayHeight);
