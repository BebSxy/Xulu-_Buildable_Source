...
extends FramebufferShader {
    ...
    public void updateUniforms() {
        ...
        GL20.glUniform2f((int)this.getUniform("resolution"), (float)((float)new ScaledResolution(this.mc).getScaledWidth() / 2.0f), (float)((float)new ScaledResolution(this.mc).getScaledHeight() / 2.0f));
