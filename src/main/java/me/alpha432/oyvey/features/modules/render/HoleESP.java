...
extends Module {
    ...
    public void onUpdate() {
        ...
        for (BlockPos pos : blockPosList) {
            if (!EntityUtil.posEqualsBlock(pos, Blocks.AIR).booleanValue() || EntityUtil.posEqualsBlock(pos.add(0, -1, 0), Blocks.AIR).booleanValue() || !EntityUtil.posEqualsBlock(pos.add(0, 1, 0), Blocks.AIR).booleanValue() || !EntityUtil.posEqualsBlock(pos.add(0, 2, 0), Blocks.AIR).booleanValue()) continue;
