...
extends Module {
    ...
    public static final Setting<Integer> gL = new Setting<Integer>("BlueLine", 26, 0, 255); //RBG :cold_face:
    ...
    public static final Setting<Integer> gF = new Setting<Integer>("BlueFill", 26, 0, 255); //RBG :cold_face:
