...
extends Module {
    ...
    private void placeCrystal(BlockPos pos) {
        boolean mainhand = AntiTrap.mc.player.getHeldItemMainhand().getItem() == Items.END_CRYSTAL;
        boolean bl = mainhand;
        ...
        float[] angle = MathUtil.calcAngle(AntiTrap.mc.player.getPositionEyes(Util.mc.getRenderPartialTicks()), new Vec3d((double)((float)pos.getX() + 0.5f), (double)((float)pos.getY() - 0.5f), (double)((float)pos.getZ() + 0.5f)));
